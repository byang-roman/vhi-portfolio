                ...
                <div className="bg-white p-6 rounded-lg shadow-md border mb-4">
                    ...
                    <ul className="list-disc pl-4 mt-2">
                        ...
                        <li className="text-lg md:text-xl leading-relaxed">
                            Proactively addressed client issues and concerns. Maintaining a high responsiveness rate, and always making sure that features, functionalities, amendments are implemented
                            on time through effective teamwork and collaboration.
                        </li>
                    </ul>
                </div>
